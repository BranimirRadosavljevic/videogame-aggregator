...
<div class="container mx-auto px-4">
    <div class="game-details border-b border-gray-800 pb-12 flex">
        ...
        <div class="ml-12 mr-64">
            ...
            <p class="mt-12">
                A spectacular re-imagining of one of the most visionary games ever, Final Fantasy VII Remake rebuilds
                and expands the legendary RPG for today. The first game in this project will be set in the eclectic city
                of Midgar and presents a fully standalone gaming experience.
            </p>
            <div class="mt-12">
                <button
    ...
    <div class="similar-games-container mt-8">
        ...
        <div class="text-sm grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-12">
            <!-- Popular Games -->
            <div class="game mt-8">
